...
#   ansible-pull -u https://github.com/gkeerthi921-ui/ansible.git -e component=$component main.yaml#!/bin/bash
...
REPO_URL=https://github.com/gkeerthi921-ui/ansible-roboshop-roles-tf.git
